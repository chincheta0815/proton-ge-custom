...
HIDDEN LONG STDMETHODCALLTYPE Init(LPWINEASIO iface, void *sysRef)
{
    ...
    /* Get and count JACK ports 
       We should also count virtual ports. On PipeWire, the first ports are always the ones of the selected input/output devices 
    */
    This->jack_input_ports = jackbridge_get_ports(This->jack_client, NULL, NULL, JackPortIsOutput);
    for (This->jack_num_input_ports = 0; This->jack_input_ports && This->jack_input_ports[This->jack_num_input_ports]; This->jack_num_input_ports++)
        ;
    This->jack_output_ports = jackbridge_get_ports(This->jack_client, NULL, NULL, JackPortIsInput);
